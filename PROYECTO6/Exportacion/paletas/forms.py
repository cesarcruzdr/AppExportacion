...
#Cantidad de baterias no puede ir en blanco
    ...
    def clean(self):
        ...
        # Asegurarse de que solo uno de los pesos se ingrese
        if peso_bruto_kg and peso_bruto_lb:
            raise forms.ValidationError("Solo se puede ingresar uno de los pesos (bruto en kg o bruto en lb).")
